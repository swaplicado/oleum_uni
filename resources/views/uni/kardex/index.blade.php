            ...
            <div class="accordion-item" style="border: solid 0.03cm #7E7E7E">
                <h2 class="accordion-header" id="flush-headingOne">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="" style="width: 40%; border-right: solid 0.03cm black">
                            <div class="fw-bold">
                                @if (!$area->is_active)
                                {{ $area->knowledge_area }}
                                @else
                                <a href="#" class="btn btn-primary" style="width: 90%; height: 5rem;"
                            ...
                            <br>
                            Vigencia: <i>{{ \Carbon\Carbon::parse($area->dt_assignment)->format('d-M-Y').' - '.\Carbon\Carbon::parse($area->dt_end)->format('d-M-Y') }}</i>
                            <br>
                            <div>
                                <span>Avance: </span>
                            ...
                            <h2 class="accordion-header" id="flush-headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="" style="width: 40%; border-right: solid 0.03cm black">
                                        ...
                                        @else
                                        <div class="fw-bold">
                                            <a href="#" class="btn btn-info" style="width: 90%; height: 4.5rem;"
                                        ...
                                        <div class="progress" style="width:70%; background-color: #9F9F9F">
                                            <div class="progress-bar bg-success" role="progressbar"
                                                style="width:{{$module->completed_percent}}%" aria-valuenow="25"
                                    ...
                                    <div class="accordion-item" style="border: solid 0.03cm #CECECE">
                                        <h2 class="accordion-header" id="flush-headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#course{{$course->id_course}}"
                                                aria-expanded="false" aria-controls="module{{$course->id_course}}">
                                                <div class="" style="width: 40%; border-right: solid 0.03cm black">
                                                    <div class="fw-bold" style="color: #f7990c">{{ $course->course }}
                                                    </div>
                                                    <br>
                                                    <span>Avance: </span>
                                                ...
                                                <div style="margin-left: 5px;">
                                                    <span>Calificación promedio:</span>
                                                    <span class="badge bg-secondary rounded-pill">{{ $course->grade[1]
                                                        == null || $course->grade[1] == 0 ? "-" : $course->grade[1]
                                                        }}</span>
                                                    @if ($course->has_document && $course->elem_status_id == 3 &&
                                                    $course->grade[0])
                                                    <br>
                                                    <br>
                                                    <a type="button" class="btn btn-warning"
                                        ...
                                        <div id="course{{$course->id_course}}" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingTwo">
                                            <br>
                                            <label for="">Contenido del curso:</label>
                                            <div class="accordion-body">
                                                ...
                                                <li
                                                    ...
                                                    <span class="badge bg-primary rounded-pill">{{ $topic->grade[1] ==
                                                        null || $topic->grade[1] == 0 ? "-" : $topic->grade[1] }}</span>
                                                </li>
                                                <div class="card-body">
                                                    <ul class="list-group">
                                                        ...
                                                        <li
                                                            ...
                                                            <span class="badge bg-primary rounded-pill">{{
                                                                $subtopic->grade[1] == null || $subtopic->grade[1] == 0
                                                                ? "-" : $subtopic->grade[1] }}</span>
                                                        </li>
                                                        @endforeach
                                                    </ul>
                                                </div>
