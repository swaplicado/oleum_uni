...
<div class="row">
    <div class="col-6">
        ...
        <input type="date" class="form-control" id="dt_start" name="dt_start" v-model="dtStart" required>
    </div>
    <div class="col-6">
        <label for="dt_end" class="form-label">Fecha término*:</label>
...
<div class="mb-3 col-3">
    <label for="num_days" class="form-label">Duración (días)*:</label>
...
<div v-if="iAssignmentBy == 5" class="mb-3">
